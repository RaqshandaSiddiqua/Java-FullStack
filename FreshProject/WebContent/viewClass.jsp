...
if(mySession==null){
	...
	response.setHeader("refresh", "5;url='/FreshProject'");
}
else{
...
<tr><td>&nbsp;&nbsp;<a href="/FreshProject/Dashboard.jsp">Dashboard</a>&nbsp;&nbsp;</td></tr>
</table>
<br/>
...
<tr>
<td>Standard </td><td><input type="number" name="standard" min="0" placeholder="standard (1 to 12)"></td>
</tr>
<tr>
<td>Division </td><td><input type="text" name="division" placeholder="division (A/B/C/D)"></td>
...
<%} else{
response.sendRedirect("/FreshProject/Dashboard.jsp");
%>
